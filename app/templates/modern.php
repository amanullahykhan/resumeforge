...
'render' => function (array $d): string {
    ...
    . '<td style="width:34%;background:' . $t['sidebar'] . ';color:' . $t['side_text'] . ';padding:' . $pad . 'px 18px;vertical-align:top">'
    . Tpl::photo($d, true)
    ...
    . '<td style="width:66%;vertical-align:top;padding:' . $pad . 'px 22px">' . Tpl::summary($d) . Tpl::mainSections($d) . '</td>'
    . '</tr></table></div>';
}];