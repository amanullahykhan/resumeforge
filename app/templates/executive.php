...
'render' => function (array $d): string {
    ...
    . '<div style="padding:' . ($pad - 2) . 'px ' . ($pad + 4) . 'px 14px;border-bottom:4px solid ' . $t['accent'] . '"><table style="width:100%;border-collapse:collapse;table-layout:fixed"><tr>'
    ...
    . '<td style="width:66%;padding:20px 22px ' . $pad . 'px ' . ($pad + 4) . 'px;vertical-align:top">' . Tpl::summary($d) . Tpl::mainSections($d) . '</td>'
    . '<td style="width:34%;padding:20px ' . ($pad + 4) . 'px ' . $pad . 'px 18px;border-left:1px solid #e5e7eb;vertical-align:top">'
